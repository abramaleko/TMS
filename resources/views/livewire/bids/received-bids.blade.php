...
<div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
  <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-10 w-10">
                    <img class="h-10 w-10 rounded-full" src="{{asset('storage/'.$bid->tenant->profile_photo_path)}}" alt="{{$bid->tenant->name}}">
                  </div>
                  <div class="ml-4">
     ...
     <div class="grid justify-items-center bg-white">
      <h1 class="my-8 text-2xl text-gray-600"><img src="{{'icons/sad.png'}}" alt="sad" class="inline"> Sorry, you have not received any bids yet</h1>
      </div>
     @endif
  </div>
</div>
