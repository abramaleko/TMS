            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form  autocomplete="off" wire:submit.prevent="registerTenant">
                    ...
                    <div class="block mt-3">
                        <div class="ml-5">
                                <h1 class=" sm:text-3xl text-2xl font-bold  text-gray-700 ml-7 mb-2">Contract Attachments</h1>
                                <p class="text-red-600 text-serif mb-1">*****Attachments are optional to upload*****</p>
                                <p class="text-red-600 text-serif mb-1">Any file uploaded now will replace the previous uploaded files in the same sequential order ,to download the previous files <a href="/contract/{{$contract_id}}" class="text-blue-500 hover:underline">click here</a></p>
                    ...
                    <button class="ml-4 border-2 rounded-md my-7 py-2 px-4 bg-blue-700 focus:outline-white hover:bg-blue-500	text-white  tracking-wide font-bold " type="submit">Update</button>
                </form>
            </div>
        </div>
    </div>
