            ...
            <div class="p-3">
                <form method="POST" autocomplete="off" wire:submit.prevent="registerRental" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap">
                     ...
                     <input type="text" id="district" wire:model.defer="district" class="focus:outline-none ml-5 px-4 py-2 w-56 md:w-45 rounded-md border-2 border-blue-400 form-input sm:mt-2" placeholder="i.e Kinondoni">
                      </div>
