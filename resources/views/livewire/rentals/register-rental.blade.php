        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="p-3">
            ...
            <div class="flex flex-wrap">
                ...
                <select id="region" wire:model.defer="region" class="form-select ml-5 px-4 py-2 w-56 md:w-45 rounded-md  border-2 border-blue-400 sm:mt-2 focus:outline-none" >
              ...
              @endif 
                 ...
                 <div class="mb-4 md:ml-4">
                    ...
                    <select id="space for" wire:model.defer="space_for" class="form-select focus:outline-none ml-5 px-4 py-2 w-45 rounded-md  md:w-45 border-2 border-blue-400 sm:mt-2" >
                 ...
                 <div class="mb-4">
                    ...
                    <input type="number" wire:model.defer="price" class="form-input focus:outline-none ml-3 px-4 py-2 w-56  md:w-45 rounded-md border-2 border-blue-400 form-input sm:mt-2" min="1">
                     </div>
        
                     <div class="mb-4 md:ml-4">
                      <label for="negotiation" class="text-gray-800">Price negotiation :</label>
                      <select id="negotiation" wire:model.defer="negotiation" class="form-select focus:outline-none ml-5 px-4 py-2 w-45 rounded-md  w-56 md:w-40 border-2 border-blue-400 sm:mt-2" >
                        <option selected>Choose..</option>
           ...
           <div class="mb-4 block">
            ...
            <textarea wire:model.debounce.500ms="description" class="focus:outline-none mt-2 px-4 py-2 w-72  rounded-md border-2 border-blue-500 form-textarea" rows="5" placeholder="How big is the space or house,how many rooms,toilet does it have?"></textarea>
          </div>
          <div class="mb-4 block">
