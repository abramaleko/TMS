                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="py-4 flex justify-center">
                                 <a href="" class="border-2 border-gray-300 hover:bg-blue-500 text-black hover:bg-transparent font-semibold hover:text-white border-transparent px-7 py-3"><img src="{{asset('icons/google.png')}}" alt="google" class="h-8 px-2 inline"> Sign up with Google</a>
                                </div>
                             </div>
                        </form>
                       </div>
